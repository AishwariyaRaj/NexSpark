      ...
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-6">
            ...
            <Link to="/search" className="text-gray-700 hover:text-orange-600 font-medium transition-colors">Search</Link>
            ...
            {isAuthenticated ? (
              <>
                ...
                {(user?.role === 'ADMIN' || user?.email === 'admin@nexspark.com') && (
                  <Link
                    to="/admin"
                ...
                <div className="flex items-center space-x-3">
                  <span className="text-gray-800 font-medium">{user?.firstName ? `${user.firstName}` : user?.email}</span>
                  <button
                    onClick={handleLogout}
                    className="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-lg transition-colors font-semibold"
                  >
                    Logout
                  </button>
                </div>
              ...
              <>
                ...
                <Link
                  to="/register"
                  className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-2 rounded-lg font-semibold transition-all shadow-lg"
                >
                  Register
                </Link>
              </>
